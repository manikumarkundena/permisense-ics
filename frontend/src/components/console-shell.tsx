...
import { Activity, Bot, CircleAlert, LockKeyhole, Radio, ShieldCheck } from "lucide-react";
import { ThemeToggle } from "./theme-toggle";

export function ConsoleShell({ children }: { children: React.ReactNode }) {
  return <main className="console-page">
    <header className="console-header"><div className="shell console-header-inner"><Link href="/" className="console-brand"><ShieldCheck size={17}/> PERMISENSE</Link><div className="console-header-right"><span className="console-state"><span/> OPERATOR CONSOLE</span><ThemeToggle/></div></div></header>
    <div className="shell console-layout">
      <aside className="console-sidebar">
        ...
        <div className="console-meta">01 · Normalize</div><div className="console-meta">02 · Detect</div><div className="console-meta">03 · Correlate</div><div className="console-meta">04 · Impact + risk</div><div className="console-meta">05 · Respond + recover</div>
      </aside>
